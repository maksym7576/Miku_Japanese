...
//import com.japanese.lessons.models.sixsth.Audio;
//import com.japanese.lessons.models.sixsth.Image;
...
//        Image image = imagesService.getImageById(index.getActivityId());
...
//        Text text = mangaDialogueService.getMangaDialogueById(index.getActivityId());
...
//        Question question = questionService.getQuestionById(index.getActivityId());
